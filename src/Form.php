...
/**
 * It's a part of a web page that has form controls, such as text, buttons, checkboxes, range, or color picker controls.
 *
 * A user can interact with such a form, providing data that can then be sent to the server for further processing (for
 * example, returning the results of a search or calculation).
 *
 * No client-side scripting is often needed, though an API is available so that scripts can augment the user experience
 * or use forms for purposes other than submitting data to a server.
 *
